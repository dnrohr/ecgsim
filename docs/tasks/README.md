...
- [x] [0091 Expand Heart Surface Mode Tests Across Initial Adapted And Time](0091-expand-heart-surface-mode-tests-across-initial-adapted-and-time.md)

## VF3: Thorax View Completeness

- [x] [0092 Add Thorax Heart Context Overlay](0092-add-thorax-heart-context-overlay.md)
- [x] [0093 Add Thorax Line Only Isofunction Mode](0093-add-thorax-line-only-isofunction-mode.md)
- [x] [0094 Add Thorax Lock To Heart Orientation](0094-add-thorax-lock-to-heart-orientation.md)
- [x] [0095 Expand Thorax Probe And Electrode Target Workflows](0095-expand-thorax-probe-and-electrode-target-workflows.md)
...
- [x] [0100 Add Electrogram Visualization Or Evidence Blocker](0100-add-electrogram-visualization-or-evidence-blocker.md)
...
- [x] [0120 Fix Launch Heart Visibility And Shell Menu Actions](0120-fix-launch-heart-visibility-and-shell-menu-actions.md)
