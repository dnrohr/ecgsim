...
| Heart | Endocardial/epicardial and transmural mapping | Disabled until wall mappings are parsed | blocked-on-evidence | PGraphGeometry inventory exists; wall-side pairing semantics still need decoding | future |
