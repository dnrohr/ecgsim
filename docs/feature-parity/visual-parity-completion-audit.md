...
| Leads | Measured/initial/adapted overlays | `PMatrix` roles are inventoried, but measured/initial signal classification and standard/BSPM WCT/reference lead-transform semantics are not decoded. |
