...
| Leads | Measured/initial/adapted overlays | `PMatrix` roles and lead/reference labels are inventoried, but measured/initial signal classification and standard/BSPM WCT/reference trailing-field semantics are not decoded. |
