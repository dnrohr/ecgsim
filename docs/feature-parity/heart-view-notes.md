...
- Cross-plane clipping, probe mode, foci editing, contribution maps, remaining accumulation policies, heart vector display, electrode visibility, movie playback, and clipboard export remain unsupported until their roadmap tasks.
