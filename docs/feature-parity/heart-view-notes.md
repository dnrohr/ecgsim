...
- Cross-plane clipping, probe mode, foci editing, contribution maps, legacy named-region accumulation variants, heart vector display, electrode visibility, movie playback, and clipboard export remain unsupported until their roadmap tasks.
