...
| Leads | Measured/initial/adapted overlays | App workflow toggles promoted normal-male measured `.refECG`, initial, adapted, and initial+adapted overlays; smoke tests cover measured export fixture metadata and recompute dimensions | medium | Arbitrary case-payload measured classification and final lead transform/WCT parity unresolved |
